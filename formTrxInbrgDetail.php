...
<body>
  ...
  <div class="container mt-4 mb-5">
    <h2 class="text-center">Form Penerimaan Barang Detail</h2>

    <form action="" method="post">

      <div class="mb-2">
        <label for="TrxInNoHeader" class="form-label">No Transaksi: </label>
				<select name="TrxInNoHeader" id="TrxInNoHeader" class="form-control" required>
