...
INNER JOIN `tb_penerimaanbrgheader` `TrxInHeader` ON `TrxInHeader`.`TrxInPK` = `TrxInDetail`.`TrxInIDF`");
...
<div class="container mt-4">
  <h2 class="text-center">Data Transaksi Barang Masuk Detail</h2>
  
  <a href="formTrxInbrgDetail.php" class="btn btn-info bg-gradient mt-3">Tambah data Barang Masuk</a>
