...
<body>
  ...
  <div class="container mt-4 mb-5">
    ...
    <form action="" method="post">
      <div class="mb-2">        
        <label for="TrxInNo" class="form-label">No Transaksi: </label>
				<input type="text" class="form-control" name="TrxInNo" id="TrxInNo" required>
      </div>
      ...
      <div class="mb-2">
        <label for="suppId" class="form-label">Pilih Supplier: </label>
