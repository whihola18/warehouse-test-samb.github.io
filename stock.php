...
$result = query("SELECT * FROM m_product");
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="stock.php">Stock Barang</a>
        </li>
      </ul>
  ...
  <form action="" method="post">
      <table>
          <tr>
              ...
              <th>
                  <button type="submit" name="search" class="btn btn-primary bg-primary" style="padding: 2px 30px;">Cari</button>
              </th>
          </tr>
      </table>
  </form>

<h2 class="text-center mt-3">STOCK BARANG</h2>
