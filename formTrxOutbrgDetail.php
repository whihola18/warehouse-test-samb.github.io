	...
	if( TrxOutBrgDetail($_POST) > 0 ) {
		echo "
			<script>
				...
				document.location.href = 'dataBrgOutDetail.php';
			</script>
		";
	} else {
		echo "
...
<nav class="navbar navbar-expand-lg bg-info bg-gradient">
  <div class="container">
	...
	<h1>Form Pengeluaran Barang Detail</h1>

	<form action="" method="post">
		<ul>
			<li>
				<label for="TrxOutNoHeader">No Transaksi: </label>
				<select name="TrxOutNoHeader" id="TrxOutNoHeader" required>
